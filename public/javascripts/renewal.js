...
function checkFinish() {
    if (max_page <= cur_page && 0 < userInfo.length) {
        ...
        document.body.appendChild(a), sa(a, "action", "https://dev-anzuinfo.me/saveScore"), sa(a, "accept-charset", "UTF-8"), sa(a, "method", "post"), sa(e = document.createElement("input"), "type", "text"), sa(e, "name", "user"), sa(e, "value", userInfo), a.appendChild(e);
        var i = document.createElement("input");
        sa(i, "type", "text"), sa(i, "name", "track"), sa(i, "value", t), a.appendChild(i), a.submit(), console.log("finish!")
    }
}
...
$(function() {
    ...
    e.attr("id", "pg"), e.text("준비 중입니다..."), $("body").append(t), $("body").append(e), $.ajax({
        type: "GET",
        url: "https://p.eagate.573.jp/game/sdvx/vi/playdata/profile/index.html",
        success: function(t) {
            var e, a, i, n, p;
            e = $(t).find("#player_id").text(), a = $(t).find("#player_name p:nth-child(2)").text(), i = $(t).find("#force_point").text(), n = $(t).find(".profile_skill").attr("id").replace("skill_", ""), p = $(t).find(".profile_cnt").first().text().replace("回", ""), "" != e ? userInfo = e + "\t" + a + "\t" + i + "\t" + n + "\t" + p : $("#pg").text("e-amusement 로그인이 되어있지 않습니다.")
        }
    }), $.ajax({
        type: "GET",
